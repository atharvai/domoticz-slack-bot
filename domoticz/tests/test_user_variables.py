...
class TestUserVariables(unittest.TestCase):
    ...
    def test_get_all_variables_returns_five_vars(self, m):
        ...
        m.get('http://mydomoticz:8080/json.htm?type=command&param=getuservariables',
              text='{{"status":"OK", "result":{data}}}'.format(data=json.dumps(self.all_vars)))
    ...
    def test_get_variable_by_idx_returns_one(self, m):
        domo = domoticz.Domoticz('mydomoticz')
        m.get('http://mydomoticz:8080/json.htm?type=command&param=getuservariable&idx=1',
              text='{{"status":"OK", "result":{data}}}'.format(data=json.dumps([self.var_integer])))
    ...
    def test_get_variable_by_name_returns_dummyval(self, m):
        ...
        m.get('http://mydomoticz:8080/json.htm?type=command&param=getuservariables',
              text='{{"status":"OK", "result":{data}}}'.format(data=json.dumps(self.all_vars)))
        m.get('http://mydomoticz:8080/json.htm?type=command&param=getuservariable&idx=3',
              text='{{"status":"OK", "result":{data}}}'.format(data=json.dumps([self.var_str])))
    ...
    def test_get_variable_float_returns_float(self, m):
        domo = domoticz.Domoticz('mydomoticz')
        m.get('http://mydomoticz:8080/json.htm?type=command&param=getuservariable&idx=2',
              text='{{"status":"OK", "result":{data}}}'.format(data=json.dumps([self.var_float])))
    ...
    def test_get_variable_date_returns_date(self, m):
        domo = domoticz.Domoticz('mydomoticz')
        m.get('http://mydomoticz:8080/json.htm?type=command&param=getuservariable&idx=4',
              text='{{"status":"OK", "result":{data}}}'.format(data=json.dumps([self.var_date])))
    ...
    def test_get_variable_time_returns_time(self, m):
        domo = domoticz.Domoticz('mydomoticz')
        m.get('http://mydomoticz:8080/json.htm?type=command&param=getuservariable&idx=5',
              text='{{"status":"OK", "result":{data}}}'.format(data=json.dumps([self.var_time])))
    ...
    def test_create_or_update_user_variable_returns_new_ok(self, m):
        ...
        m.get('http://mydomoticz:8080/json.htm?type=command&param=getuservariable&idx=6',
              text='{{"status":"OK", "result":{data}}}'.format(data=json.dumps([self.var_new])))
    ...
    def test_create_or_update_user_variable_returns_updates_value(self, m):
        ...
        m.get('http://mydomoticz:8080/json.htm?type=command&param=getuservariables',
              text='{{"status":"OK", "result":{data}}}'.format(data=json.dumps(self.all_vars)))
        m.get(
            'http://mydomoticz:8080/json.htm?type=command&param=saveuservariable&vname=var_str&vtype=2&vvalue=newvalue',
            text='{"status":"OK"}')
        m.get(
            'http://mydomoticz:8080/json.htm?type=command&param=updateuservariable&vname=var_str&vtype=2&vvalue=newvalue',
            text='{"status":"OK"}')
        result = domo.create_or_update_user_variable('var_str', 'newvalue')
        var_string = self.var_str.copy()
        var_string['Value'] = 'newvalue'
        m.get('http://mydomoticz:8080/json.htm?type=command&param=getuservariable&idx=3',
              text='{{"status":"OK", "result":{data}}}'.format(data=json.dumps([var_string])))
    ...
    def test_delete_user_variable_returns_ok(self, m):
        domo = domoticz.Domoticz('mydomoticz')
        m.get('http://mydomoticz:8080/json.htm?type=command&param=getuservariables',
              text='{{"status":"OK", "result":{data}}}'.format(data=json.dumps(self.all_vars[1:])))
